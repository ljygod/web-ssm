...
<FORM id=form1 name=form1 onsubmit="javascript:return WebForm_OnSubmit();" method=post action="/user/selectUserById">
                                ...
                                <TD>
                                    <TABLE cellSpacing=0 cellPadding=2 border=0>
                                        ...
                                        <TR>
                                            ...
                                            <TD style="HEIGHT: 28px" width=150><INPUT id="user_id" type="text"
                                                                                      style="WIDTH: 130px" name="user_id">
                                            </TD>
